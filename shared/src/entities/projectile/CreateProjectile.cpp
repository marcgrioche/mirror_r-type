...
namespace factories {
void createProjectile(std::shared_ptr<Registry> registry, Vector2 position, Vector2 velocity,
...
void createProjectile(std::shared_ptr<Registry> registry, const Position& position, const Velocity& velocity,
